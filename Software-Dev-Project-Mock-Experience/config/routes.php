...
return static function (RouteBuilder $routes) {
    ...
    $routes->prefix('admin', function (RouteBuilder $routes) {
        $routes->connect('/', ['controller' => 'Users', 'action' => 'login']); //connect that default
        $routes->fallbacks(DashedRoute::class);
    });

    $routes->prefix('client', function (RouteBuilder $routes) {

        $routes->connect('/', ['controller' => 'Customers', 'action' => 'index']); //connect that default
        $routes->fallbacks(DashedRoute::class);
    });
    ...
    $routes->connect('/fullcalendar/ajax', ['controller' => 'FullCalendar', 'action' => 'ajax']
    );
