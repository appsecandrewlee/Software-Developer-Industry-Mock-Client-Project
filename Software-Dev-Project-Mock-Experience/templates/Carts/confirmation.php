    ...
    <header class="bg-light rounded py-5">
        <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
            <div class="text-center text-black">
                <h1 class="display-4 fw-bolder">Congratulations!
                    <h2>Confirmation items on hold:</h2>

                    <p>Course: <?= h($course->name) ?></p>
                    <p>Quantity: <?= h($cart->quantity) ?></p>
                    <p>Total cost: <?= h($cart->cost) ?></p></h1>
                    <p>Reference Number: <?= h($referenceNumber) ?></p>

                <p class="lead fw-normal text-black-50 mb-0">Please note down this receipt, and call our store for payment!</p>
            </div>

        </div>
        </div>
        <div class="text-center">
            <a class="btn btn-outline-dark mt-auto"<?= $this->Html->link('Back to homepage', ['controller' => 'Pages', 'action' => 'home'], ['class' => 'button']) ?></a>
        </div>
