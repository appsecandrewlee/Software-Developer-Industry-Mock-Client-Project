    ...
    <header class="bg-light rounded py-5">
        <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
            <div class="text-center text-black">
                ...
                <p class="lead fw-normal text-black-50 mb-0">Your booking has been confirmed.</p>
            </div>

            </div>
        </div>
        <div class="text-center">
            <a class="btn btn-outline-dark mt-auto"<?= $this->Html->link('Back to bookings', ['controller' => 'Events', 'action' => 'index'], ['class' => 'button']) ?></a>
        </div>
