                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            ...
                            <p>Hi <?= h($first_name) ?>, </p>
                            <p>Thank you for your request to reset the password of your account on <b>Holistic Healings</b>. </p>
                            <p></p>
                                ...
                                <tr>
                                    <td align="left">
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                            <tbody>
                                            <tr>
                                                <td><a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'changePassword', $nonce], ['fullBase' => true]) ?>" target="_blank">Reset account password</a></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </td>
                            ...
                            <p>or use the following link: <br>
                                <?= $this->Html->link($this->Url->build(['controller' => 'Users', 'action' => 'changePassword', $nonce], ['fullBase' => true]), ['controller' => 'Users', 'action' => 'changePassword', $nonce], ['fullBase' => true, 'style' => 'word-break:break-all']) ?></p>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td class="content-block">
                    ...
                    <br>
                    <br>
                    Copyright &copy; <?= date("Y"); ?> Holistic Healings
                </td>
            </tr>
        </table>
    </div>
